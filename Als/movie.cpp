...
/***
	Método: 	factorize()
	Función:	Llamado a la función "als" para procesar el vector que fue llenado con los datos de "data.txt"
**/
void factorize() {
...
/***
	Método: 	als()
	Función:	Evaluación a través de métodos con matrices utilizando variables de rating de clientes, usuarios y películas
